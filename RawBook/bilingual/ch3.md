...
![Figure 3-1. Common set of frameworks, libraries, compilers, runtimes, and tools used to develop and productionize modern LLM workloads](../images/figure-3-1.png)

![图 3-1. 一组用于开发并将现代 LLM 工作负载投入生产的常见框架、库、编译器、运行时与工具](../images/figure-3-1.png)
...
![Figure 3-2. Using `nvcc` to compile a CUDA program into PTX—and ultimately the low-level instructions for the GPU target device](../images/figure-3-2.png)

![图 3-2. 使用 `nvcc` 将 CUDA 程序编译为 PTX——并最终编译为面向 GPU 目标设备的底层指令](../images/figure-3-2.png)
...
![Figure 3-3. Flow from PyTorch code to GPU device](../images/figure-3-3.png)

![图 3-3. 从 PyTorch 代码到 GPU 设备的流程](../images/figure-3-3.png)
...
![Figure 3-4. Eight GPUs in a node, with four GPUs connected to NUMA node 0 and the other four to NUMA node 1](../images/figure-3-4.png)

![图 3-4. 一个节点中的八个 GPU，其中四个连接到 NUMA 节点 0，另外四个连接到 NUMA 节点 1](../images/figure-3-4.png)
...
![Figure 3-5. Pinned memory (aka page-locked or nonpageable) is a type of memory that cannot be swapped out to disk](../images/figure-3-5.png)
...
![Figure 3-6. GPU alternates between running Process A’s kernels and Process B’s kernels and creates idle gaps in which one process is waiting while the other is active](../images/figure-3-6.png)
...
![Figure 3-7. Reducing idle gaps for processes A and B using MPS](../images/figure-3-7.png)
...
![Figure 3-8. Seven MIG slices on a modern GPU](../images/figure-3-8.png)
