...
![Figure 13-1. Compiled (left and middle, pink) versus noncompiled (right, green) regions (source: https://oreil.ly/Z_fJG)](../images/figure-13-1.png)

![图 13-1. 已编译区域（左、中，粉色）与未编译区域（右，绿色）（来源：https://oreil.ly/Z_fJG）](../images/figure-13-1.png)
...
![Figure 13-2. Roofline chart before and after increasing arithmetic intensity of this kernel](../images/figure-13-2.png)

![图 13-2. 提升该核函数算术强度前后的 Roofline 图](../images/figure-13-2.png)
...
![Figure 13-3. FlexAttention provides support for custom attention variants.](../images/figure-13-3.png)

![图 13-3. FlexAttention 为自定义注意力变体（attention variant）提供支持。](../images/figure-13-3.png)
...
![Figure 13-4. Overlapping compute and data transfer with dedicated compute and transfer streams](../images/figure-13-4.png)

![图 13-4. 使用专用的计算流与传输流实现计算与数据传输的重叠](../images/figure-13-4.png)
...
![Figure 13-5. PyTorch memory profile visualization for three iterations of a forward and backward pass](../images/figure-13-5.png)

![图 13-5. 三次前向与反向传播迭代的 PyTorch 内存剖析可视化](../images/figure-13-5.png)
...
![Figure 13-6. FSDP shards model parameters, gradients, and optimizer states across the GPUs (ZeRO Stage-3)](../images/figure-13-6.png)

![图 13-6. FSDP 将模型参数、梯度和优化器状态分片到多个 GPU 上（ZeRO Stage-3）](../images/figure-13-6.png)
...
![Figure 13-7. PyTorch HUD dashboard (source: https://oreil.ly/JxLKJ)](../images/figure-13-7.png)

![图 13-7. PyTorch HUD 仪表板（来源：https://oreil.ly/JxLKJ）](../images/figure-13-7.png)
