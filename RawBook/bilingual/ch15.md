...
![Figure 15-1. Disaggregated prefill and decode sharing the KV cache and overlapping KV transfers with computations](../images/figure-15-1.png)
...
![Figure 15-2. Disaggregated inference: Prefill pool (hidden state + KV) → KV handoff using NVLink/NVSwitch (intranode) or GPUDirect RDMA (internode) → Decode pool](../images/figure-15-2.png)
...
![Figure 15-3. KV cache data transfers with NIXL in the vLLM inference engine; Intranode: NVLink/NVSwitch (device-to-device); Internode: GPUDirect RDMA (InfiniBand/RoCEv2) using ConnectX-class NICs](../images/figure-15-3.png)
...
![Figure 15-4. Kubernetes-based vLLM cluster of separate prefill and decode workers using the open source llm-d project; variant autoscaler tunes prefill/decode replica counts based on the prompt-response mix; KV moved using LMCache and NIXL](../images/figure-15-4.png)
...
![Figure 15-5. Model weights and input data split over the GPUs](../images/figure-15-5.png)
...
![Figure 15-6. Mixture-of-experts (MoE) communication (source: https://oreil.ly/pzn5t)](../images/figure-15-6.png)
...
![Figure 15-7. High-level diagram of a 4 × 2 × EP hybrid parallel combination (source: https://oreil.ly/q1AEf)](../images/figure-15-7.png)
...
![Figure 15-8. Speculative decoding with a draft (small) for decoding and a target (large) model for multitoken verification](../images/figure-15-8.png)
...
![Figure 15-9. Speculative decoding with EAGLE-2 (source: https://oreil.ly/uG07b)](../images/figure-15-9.png)
...
![Figure 15-10. Multitoken decoding with Medusa (source: https://oreil.ly/MJMOQ)](../images/figure-15-10.png)
...
![Figure 15-11. Each GPU receives only the tokens it needs for the expert(s) that it hosts](../images/figure-15-11.png)
...
![Figure 15-12. Comparing expert capacity factors of 1.0 versus 1.5](../images/figure-15-12.png)
...
![Figure 15-13. Adaptive MoE routing in action](../images/figure-15-13.png)
