...
![Figure 16-1. Lifecycle of a typical request in a disaggregated prefill and decode LLM inference system](../images/figure-16-1.png)
...
![Figure 16-2. Difference between traditional microservice invocations and LLM invocations](../images/figure-16-2.png)
...
![Figure 16-3. DCGM collects metrics from the Kubernetes GPU nodes and sends them to Prometheus](../images/figure-16-3.png)
...
![Figure 16-4. Nsight Compute’s CUDA Program Counter (PC) sampling feature helps identify hotspots in a low-overhead manner (source: https://oreil.ly/DyKWR)](../images/figure-16-4.png)
...
![Figure 16-5. Difference between static and dynamic batching](../images/figure-16-5.png)
...
![Figure 16-6. Continuous batching allows new sequences (requests) to join a batch mid-generation](../images/figure-16-6.png)
...
![Figure 16-7. NVIDIA Transformer Engine (TE) using range analysis, scaling factor, and target format for the precision conversion on a transformer layer](../images/figure-16-7.png)
...
![Figure 16-8. Prefix cache implemented as a trie data structure](../images/figure-16-8.png)
...
![Figure 16-9. Prefix cache evolution for multiple requests (source: https://oreil.ly/7LBoC)](../images/figure-16-9.png)
...
![Figure 16-10. Debouncing pauses a bit before performing an action](../images/figure-16-10.png)
